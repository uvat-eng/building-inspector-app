...
export const VIOLATIONS = [
  ...
  'Испытания, техопробования',
  'Оборудование и инструмент',
  'Общестроительные работы',
] as const;

const CAT_TO_VIOLATION: Record<string, string> = {
  'ОТ и ТБ': 'ОТ',
  'Аттестация персонала': 'Аттестация сварщиков',
  'Разрешительная документация': 'ИД, ОТД',
  'Исполнительная документация': 'ИД, ОТД',
  'Складирование и транспортировка': 'Складирование, мусор',
  'Входной контроль': 'Входной контроль',
  'Общестроительные работы': 'Общестроительные работы',
  'Сборка и сварка': 'Сварочно-монтажные работы',
  'Электромонтажные работы': 'ЭМР',
  'Оборудование и инструмент': 'Оборудование и инструмент',
  'Отступления от проектных решений / Согласование': 'Согласование проектных решений',
};

export const violationOf = (category: string) => CAT_TO_VIOLATION[category] ?? '';
