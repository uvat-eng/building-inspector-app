...
FIELDS = [
    ...
    ('objectCode', 'object_code', 'text'),
    ('contractDate', 'contract_date', 'text'),
    ('assignDocNo', 'assign_doc_no', 'text'),
    ('assignDocDate', 'assign_doc_date', 'text'),
    ('customerRep', 'customer_rep', 'text'),
